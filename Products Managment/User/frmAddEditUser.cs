...
namespace Products_Managment.User
{
    public partial class frmAddEditUser : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            _User.Password = clsUtil.Encrypt(txtConfitmPassword.Text.Trim(),key);
        ...
        void _LoadUserInfo()
        {
            ...
            txtPassword.Text = clsUtil.Decrypt(_User.Password,key);
            txtConfitmPassword.Text = txtPassword.Text.Trim() ;
            if (_User.IsManager)
            {
        ...
        {
            if (string.IsNullOrEmpty(txtUserName.Text.Trim()) && txtUserName.Text != _User.UserName)
            {
                e.Cancel = true;
